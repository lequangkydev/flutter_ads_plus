...
class InterstitialPreloadManager: BaseAdPreloadManager<InterstitialAd>, FullScreenContentDelegate {

    var currentShowingId: String?

    init(messenger: FlutterBinaryMessenger) {
        super.init(messenger: messenger, channelName: "com.app.interstitial/preload", tagLog: "InterPreloadManager")
    }

    override func loadSdkAd(adUnitId: String, completion: @escaping (InterstitialAd?, Error?) -> Void) {
        let request = Request()
    ...
    override func attachCallbacksAndShow(ad: InterstitialAd, adUnitId: String) {
